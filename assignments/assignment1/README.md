# Project 1: Virtual Machine Setup & Socket Programming

Through this project, you will gain hands-on experience with real-world network
...
The programming projects are designed to be challenging but manageable in
...
This is not a group project. **You are not allowed to copy or look at code
from other students.** However, you are welcome to discuss the project with
...
dependencies for the programming projects, saving you the tedium of
...
Run `git clone https://github.com/CSIS-BU/sp22-cs330-projects-djlin` to
download the course files from GitHub.

`cd  sp22-cs330-projects-djlin/assignments` to enter the course assignment directory.
